...
The latter because \enquote{wide receiving bandwidths are needed for fast data acquisition.}\cite[1050]{delapaz} As for any measurement (Fourier theory\info{can I prove that?}) frequency resolution, i.e. reciprocal bandwith, is proportional to the sampling time (per pixel).
Great demand on frequcny gradient coils.\change{Ausformulieren} Very loud.\change{Auch ausformulieren.}\\
...
In order to achieve the stimulus of interest inside the patient\improvement{Change this wording!}, presentation equipment including
\begin{itemize}
...
\begin{figure}[hbt]
  ...
  \begin{subfigure}[c]{0.45\textwidth}
    ...
    \subcaption{Finger tapping paradmign.}
    \label{subfig:se}
  \end{subfigure}
  \centering
  \begin{subfigure}[c]{0.45\textwidth}
    \includegraphics[width = .9\textwidth]{pictures/visualLRM.png}
    \subcaption{Visual \textit{floating chess board} paradmign.}
    \label{subfig:gre}
  \end{subfigure}
\end{figure}
